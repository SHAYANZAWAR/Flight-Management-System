...
namespace Aviate.Utils
{
          ...
          public void AddCellValue(string cellValue, int cellIndex)
          {
               switch (cellIndex)
               {
                    case 1:
                         ...
                         break;
                    case 2:
                         departureLocation = cellValue;
                         break;
                    case 3:
                         destination = cellValue;
                         break;
                    case 4:
                         departureTime = cellValue;
                         break;
                    case 5:
                         arrivalTime = cellValue;
                         break;
                    case 6:
                         aircraftID = cellValue;
                         break;
                    case 7:
                         status = cellValue;
                         break;
     ...
     public class ExcelWrite
     {
          ...
          private Row CreateHeaderRowForExcel(TestModel data)
          {
               ...
               Row workRow = new Row();
               workRow.Append(CreateCell("FlightId", 2U, 1, 1)); 
               workRow.Append(CreateCell("DepartureLocation", 2U, 1, 1));
               workRow.Append(CreateCell("Destination", 2U, 2, 1));
               workRow.Append(CreateCell("DepartureTime", 2U, 3, 1));
               workRow.Append(CreateCell("ArrivalTime", 2U, 4, 1));
               workRow.Append(CreateCell("AircraftID", 2U, 5, 1));
               workRow.Append(CreateCell("Status", 2U, 6, 1));
               workRow.Append(CreateCell("Revenue", 2U, 1, 1));
          ...
          private Row GenerateRowForChildPartDetail(TestModel testmodel)
          {
               ...
               tRow.Append(CreateCell(testmodel.FlightId, 1, rowIndex));
               tRow.Append(CreateCell(testmodel.departureLocation, 2, rowIndex));
               tRow.Append(CreateCell(testmodel.destination, 3, rowIndex));
               tRow.Append(CreateCell(testmodel.departureTime, 4, rowIndex));
               tRow.Append(CreateCell(testmodel.arrivalTime, 5, rowIndex));
               tRow.Append(CreateCell(testmodel.aircraftID, 6, rowIndex));
               tRow.Append(CreateCell(testmodel.status, 7, rowIndex));
               tRow.Append(CreateCell(testmodel.revenue, 8, rowIndex));
          ...
          private Row GenerateRowForChildPartDetail(TestModel testmodel, uint rowIndex)
          {
               ...
               tRow.Append(CreateCell(testmodel.FlightId, 1, (int)rowIndex));
               tRow.Append(CreateCell(testmodel.departureLocation, 2, (int)rowIndex));
               tRow.Append(CreateCell(testmodel.destination, 3, (int)rowIndex));
               tRow.Append(CreateCell(testmodel.departureTime, 4, (int)rowIndex));
               tRow.Append(CreateCell(testmodel.arrivalTime, 5, (int)rowIndex));
               tRow.Append(CreateCell(testmodel.aircraftID, 6, (int)rowIndex));
               tRow.Append(CreateCell(testmodel.status, 7, (int)rowIndex));
               tRow.Append(CreateCell(testmodel.revenue, 8, (int)rowIndex));
               return tRow;
          }
